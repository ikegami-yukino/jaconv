...
def hankaku2zenkaku(text: str, ignore: str = '', kana: bool = True, ascii: bool = False, digit: bool = False) -> str: ...
def han2zen(text: str, ignore: str = '', kana: bool = True, ascii: bool = False, digit: bool = False) -> str: ...
def z2h(text: str, ignore: str = '', kana: bool = True, ascii: bool = False, digit: bool = False) -> str: ...
def zenkaku2hankaku(text: str, ignore: str = '', kana: bool = True, ascii: bool = False, digit: bool = False) -> str: ...
def zen2han(text: str, ignore: str = '', kana: bool = True, ascii: bool = False, digit: bool = False) -> str: ...
def normalize(text: str, mode: typing.Literal['NFC', 'NFD', 'NFKC', 'NFKD'] = 'NFKC') -> str: ...
